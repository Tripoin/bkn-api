...
class ModelBenefitProviderStaging extends Model
{
    protected $table = IApplicationConstant::ST_BENEFIT_PROVIDER_TABLE_NAME;
    ...
    (
        ...
        IApplicationConstant::ST_BENEFIT_PROVIDER_STAGING_TYPE
    );
}